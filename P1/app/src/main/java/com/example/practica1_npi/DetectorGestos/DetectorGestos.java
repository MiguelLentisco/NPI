package com.example.practica1_npi.DetectorGestos;
...
import com.example.practica1_npi.MapaTemporal.MapaTemporal;
import com.example.practica1_npi.R;

import java.util.ArrayList;

/**
 * Modificación de GestureOverlayView.
 * Reconoce gestos para pasar de una actividad a otra. Si se realiza una Q se pasa a la actividad
 * CazaTesoros; si se realiza una M se pasa a la actividad MapaTemporal. Se carga una librería
 * predefinida donde ya se han hecho los gestos válidos. Cuando se realiza un gesto en esta
 * superficie y coincide con un gesto con cierta puntuación cambia de actividad.
 */
