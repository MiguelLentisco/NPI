...
public class MainActivity extends AppCompatActivity implements SensorEventListener{//, GestureOverlayView.OnGesturePerformedListener{

    private static final String EXTRA_MESSAGE = "com.example.practica1_NPI.CambioDeActividad";
    ...
    private double latPalacios = 37.1972543, longPalacios = -3.6240355; // Posición del ala izquierda del pasillo
