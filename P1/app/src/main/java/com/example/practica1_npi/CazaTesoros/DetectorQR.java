 ...
 * Se forma un detector de QR y se pone a detectar funcionando por debajo de la cámara.
 */
public class DetectorQR extends AppCompatActivity {
     ...
     * @see DropContenedor#escanearFoto(CazaTesoros, int) (CazaTesoros, int)
     * @see DetectorQR#iniciarDetectorQR()
     */
    @Override
     ...
     * @see DetectorQR#onCreate(Bundle)
     ...
     * Pone a funcionar en una superficie la actividad de la cámara con el detector.
     * @see DetectorQR#iniciarDetectorQR()
     */
     ...
     * Se encarga de procesar lo que detecta la cámara. Cuando lee algo de lo que hemos predefinido
     * en los QR se activa el desbloqueo de la imagen.
     * @see DetectorQR#iniciarDetectorQR()
     */
    class DetectorProcessorBarcode implements Detector.Processor<Barcode> {
         ...
         * válido. Mandamos de vuelta el ID correspondiente al QR encontrado.
